...
--object_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-LCS-558K/blip_laion_cc_sbu_558k_objects_llama.jsonl  \
--verbosity info \
--num_workers ${cpus} \
...
--username neo4j \
--password "12345678" \
--ckpt_file_path /mnt/petrelfs/songmingyang/code/mm/robustLMM/robustlmm/analysis/longTail/language_level/scripts/llama_parse/co_occurrence/ckpt/lcs558kllama.jsonl
