...
database_name=instructmix665kvisualobj
...
--object_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/llava_v1_5_mix665k_dino_stat.jsonl  \
--verbosity info \
--num_workers ${cpus} \
...
--username neo4j \
--password "12345678" \
--ckpt_file_path /mnt/petrelfs/songmingyang/code/mm/robustLMM/robustlmm/analysis/longTail/language_level/scripts/visual_parse/co_occurrence/ckpt/instructmix665kllama.jsonl \
--parser_type visual
