...
database_name=instructmix665kpos
...
--object_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/llava_v1_5_mix665k_objects_pos.json  \
--verbosity info \
--num_workers ${cpus} \
--database_name ${database_name} \
--dataset_uri neo4j://10.140.54.61:7687 \
--username neo4j \
--password "12345678" \
--ckpt_file_path /mnt/petrelfs/songmingyang/code/mm/robustLMM/robustlmm/analysis/longTail/language_level/scripts/pos/co_occurrence/ckpt/instructmix665kpos.jsonl
