...
aug_output_path=/mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/share4v_aug/new/aug_ft_120k
...
--img_dir_path /mnt/petrelfs/share_data/songmingyang/data/mm/imgs \
--output_path $aug_output_path \
--batch_size 64 \
--num_workers 4 \
--origin_alpha 1 \
--augment_alpha 120000 \
--pass_num 0 \
--candidate_img_num 2 \
--function share4v_ft
