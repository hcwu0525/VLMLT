...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/pt/origin_data_full_info/share_pt_llamaobj.json \
--img_dir_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/share4v_aug/new/aug_pt_100k \
--batch_size 64 \
--num_workers 4 \
--origin_alpha 1 \
