...
--input_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/aug/llava_v1_5_aug200k_caps.jsonl \
--output_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/aug/llava_v1_5_aug200k.jsonl  \
--function llava_caption_to_conversation \
--inference_type llava_caption_to_conversation \
--max_tokens 1024