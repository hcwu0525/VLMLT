...
--input_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/latent/llavaft/latent_reps/latent_supply/self_aug/control_sharecaptioner_caps.jsonl \
--output_file_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/latent/llavaft/latent_reps/latent_supply/self_aug/control_sharecaptioner_convs.jsonl \
