...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/share4v_aug/aug_pt_100k \
--dataset_type aug_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/pt/aug/share4v_pt_aug_caps.jsonl \
--batch_size 16 \
