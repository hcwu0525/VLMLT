...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/plain_aug/plain_aug_data.json \
--image_dir_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs \
--dataset_type plainaug_cap_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/plain_aug/plain_aug_new_conv/plain_aug_caps.jsonl \
--batch_size 16 \
