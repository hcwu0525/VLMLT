...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/share4v_aug/aug_ft_200k \
--dataset_type aug_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/ft/aug/diffaug/share4v_ft_aug_caps.jsonl \
--batch_size 16 \
