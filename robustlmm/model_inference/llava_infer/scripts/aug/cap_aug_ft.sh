...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/llava_aug/aug_ft_200k \
--dataset_type aug_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/aug/llava_v1_5_aug200k_caps.jsonl \
--batch_size 16 \
