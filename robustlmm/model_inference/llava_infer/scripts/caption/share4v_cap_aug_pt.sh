...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/val2014_annotations/captions_val2014.json \
--image_dir_path /mnt/petrelfs/songmingyang/quxiaoye/VCD_file/val2014 \
--dataset_type val2014_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/statistics/val14_llava13b_caps.jsonl \
--batch_size 16 \
