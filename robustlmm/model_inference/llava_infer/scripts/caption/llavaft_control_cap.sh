...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/llava_aug/controlaug \
--image_dir_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs \
--dataset_type aug_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/control/llavaft_control_llava13b_caps.jsonl \
--batch_size 16 \
--model_path ${model_path} \
--parallel_mode  "accelerate" \
--float_type float16 \
--aug_target_dir_path llava_aug/controlaug
