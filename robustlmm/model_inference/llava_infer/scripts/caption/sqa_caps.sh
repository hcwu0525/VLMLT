...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/hf-benchmarks/lmms-lab-ScienceQA ScienceQA-FULL \
--image_dir_path /mnt/petrelfs/songmingyang/quxiaoye/VCD_file/val2014 \
--dataset_type sqa_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/hf-benchmarks/lmms-lab-ScienceQA/ScienceQA-FULL/statistics/sqafull_caps.jsonl \
--batch_size 16 \
