...
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/latent/llavaft/latent_reps/latent_supply/self_aug/llava13b_caps.jsonl \
--batch_size 16 \
--model_path ${model_path} \
--parallel_mode  "accelerate" \
--float_type float16 \
--aug_target_dir_path latent_aug/llavaft_selfaug
