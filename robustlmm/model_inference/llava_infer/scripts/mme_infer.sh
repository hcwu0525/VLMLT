...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/MME/MME_Benchmark_release_version \
--dataset_type mme_infer \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/benchmarks/analysis/mme \
--batch_size 32 \
