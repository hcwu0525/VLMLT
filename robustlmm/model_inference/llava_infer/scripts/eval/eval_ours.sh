...
for language in ${languages[@]}; do
    ...
    inference_data=/mnt/petrelfs/songmingyang/code/tools/lmms-eval/lmms_eval/other_evals/AMBER/multilingual_data/${language}/response/${model_type}.json
    ...
    --output_file /mnt/petrelfs/songmingyang/code/tools/lmms-eval/lmms_eval/other_evals/AMBER/model_inference/scripts/eval/ours_amber_result.jsonl 
