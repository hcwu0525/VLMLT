...
vqav2_input_file=/mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/v2_OpenEnded_mscoco_val2014_questions.json
vqav2_extra_answer=/mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/v2_mscoco_val2014_annotations.json
vqav2_output_file=/mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/statistics/vqav2_tokens.jsonl
...
--input_file_path ${vqav2_input_file} \
--output_file_path ${vqav2_output_file} \
--extra_answer_file ${vqav2_extra_answer} \
--inference_type vqav2_token_parse \
--threads 16
