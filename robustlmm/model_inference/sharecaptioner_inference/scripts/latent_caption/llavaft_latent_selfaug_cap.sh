...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/latent_aug/llavaft_selfaug \
--dataset_type base \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/latent/llavaft/latent_reps/latent_supply/self_aug/sharecaptioner_caps.jsonl \
--batch_size 8 \
--model_path ${model_path} \
--float_type float16  \
--image_rel_path latent_aug/llavaft_selfaug \
