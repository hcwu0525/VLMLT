...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/llava_aug/new_aug_ft_200k \
--dataset_type base \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/new/aug/llavaft_augcap.jsonl \
--batch_size 8 \
--model_path ${model_path} \
--float_type float16  \
--image_rel_path llava_aug/new_aug_ft_200k \
