...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/imgs/share4v_aug/new/aug_pt_100k \
--dataset_type base \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/pt/aug/newaug/share4v_pt_aug_caps.jsonl \
--batch_size 8 \
--model_path ${model_path} \
--float_type float16  \
--image_rel_path share4v_aug/new/aug_pt_100k \
