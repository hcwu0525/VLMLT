...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/statistics/val14_llama_obj.jsonl \
--dataset_type val14_infer \
--image_dir_path /mnt/petrelfs/songmingyang/quxiaoye/VCD_file/val2014 \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/vqav2/statistics/val14_dino_obj.jsonl \
--batch_size 16 \
