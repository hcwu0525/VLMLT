...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/hf-benchmarks/lmms-lab-ScienceQA/ScienceQA-IMG/statistics/sqafull_llama_objects.jsonl \
--dataset_type sqa_infer \
--image_dir_path no \
--token_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/hf-benchmarks/lmms-lab-ScienceQA/ScienceQA-IMG/statistics/sqafull_tokens.jsonl \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/hf-benchmarks/lmms-lab-ScienceQA/ScienceQA-IMG/statistics/sqa_dino_obj.jsonl \
