...
accelerate_config_file=/mnt/petrelfs/songmingyang/code/mm/robustLMM/robustlmm/model_inference/llava_infer/scripts/1gpu.yaml
seed=55
...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/benchmarks/analysis/mme/mme_llama_objects.jsonl \
--dataset_type mme_infer \
--image_dir_path /mnt/petrelfs/songmingyang/songmingyang/data/mm/annotation/MME/MME_Benchmark_release_version \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/benchmarks/analysis/mme/dino_mme_objects.jsonl \
--batch_size 32 \
