...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/pt/sharegpt4v_pt_llama_objects.jsonl \
--dataset_type sharegpt4v_pt_infer \
--image_dir_path /mnt/petrelfs/share_data/quxiaoye/sharegpt4v/data \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/pt/sharegpt4v_pt_dino_objects.jsonl \
--token_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/sharegpt4v_train/pt/sharegpt4v_tokens.jsonl \
--batch_size 16 \
