...
--input_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/aug/token_aug/lm_rewrite_tail/tw_tail_200k_lm_rewrite_input.json \
--output_path /mnt/petrelfs/songmingyang/songmingyang/data/llava_train/LLaVA-Instruct-150K/reformed_data/meta_clip/aug/token_aug/lm_rewrite_tail/tw_tail_200k_replace_info.json \
